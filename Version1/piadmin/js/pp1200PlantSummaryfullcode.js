    ...
    $.each(OverallStationAnalysis, function (key) {
        ...
        $.when(batchResult1).done(function () {
            ...
            $.each(rankingElements1, function (key) {
                ...
                rows2.push(rankingElements1[key][0].mw, uom, rankingElements1[key][2].Unit1, rankingElements1[key][3].Unit2, rankingElements1[key][4].Unit3, rankingElements1[key][5].Unit4);
                //}
